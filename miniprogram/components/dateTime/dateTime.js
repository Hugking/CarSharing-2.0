Component({
  ...
  methods: {
    ...
    methods_sel(methods, val = null, flag = 0) {
      switch (methods) {
        case 'year': this.setYears(val); break;
        case 'month': this.setMonths(val); break;
        case 'day': this.setDays(val); break;
        case 'hour': this.setHours(val); break;
        case 'minute': flag != 0 ? this.setMinutes() : this.setMinutes(val); break;
        default: break;
      }
    },
    initData() {
